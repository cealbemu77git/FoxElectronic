...
/*	include('is_logged.php');//Archivo verifica que el usario que intenta acceder a la URL esta logueado
	...
	if (empty($_POST['mod_id'])) {
		...
		$sql="UPDATE products SET codigo_producto='".$codigo."', nombre_producto='".$nombre."', cantidad_producto='".$cantidad."', precio_producto='".$precio_venta."' WHERE id_producto='".$id_producto."'";
